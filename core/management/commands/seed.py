    ...
    def handle(self, *args, **options):
        if not Destination.objects.exists():
            Destination.objects.bulk_create([
                ...
                Destination(name="Male", country="Mahar orollari", flag_code="mv",
                            to_code="MLE",
        ...
        if not Tour.objects.exists():
            Tour.objects.bulk_create([
                Tour(title="Antalya",
                     ...
                     price=635, depart_date=datetime.date(2026, 5, 20), return_date=datetime.date(2026, 5, 27),
                ...
                Tour(title="Maldiv",
                     ...
                     price=995, depart_date=datetime.date(2026, 5, 25), return_date=datetime.date(2026, 6, 1),
                ...
                Tour(title="Dubay",
                     ...
                     price=560, depart_date=datetime.date(2026, 5, 22), return_date=datetime.date(2026, 5, 26),
                ...
                Tour(title="Sharm El Sheikh",
                     ...
                     duration="7 kecha / 8 kun", hotel_label="5* Hotel",
                     price=520, depart_date=datetime.date(2026, 5, 18), return_date=datetime.date(2026, 5, 26),
                ...
                Tour(title="Istanbul",
                     ...
                     price=450, depart_date=datetime.date(2026, 6, 1), return_date=datetime.date(2026, 6, 5),
                ...
                Tour(title="Batumi",
                     ...
                     price=260, depart_date=datetime.date(2026, 6, 5), return_date=datetime.date(2026, 6, 8),
